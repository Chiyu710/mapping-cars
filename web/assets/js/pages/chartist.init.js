...
new Chartist.Line("#scatter-diagram", data, options, responsiveOptions), new Chartist.Line("#line-chart-tooltips", {
    labels: ["1", "2", "3", "4", "5", "6"],
    series: [{name: "Fibonacci sequence", data: [1, 2, 3, 5, 8, 13]}, {
        name: "Golden section",
...
}, {low: 0, showArea: !0, showPoint: !1, fullWidth: !0})).on("draw", function (e) {
...
new Chartist.Bar("#overlapping-bars", data, options, responsiveOptions), new Chartist.Bar("#multi-line-chart", {
    ...
    seriesBarDistance: 10, axisX: {offset: 60}, axisY: {
    ...
    }, axisY: {offset: 20}, plugins: [Chartist.plugins.tooltip()]
...
new Chartist.Pie("#pie-chart", data, options, responsiveOptions), new Chartist.Pie("#gauge-chart", {series: [20, 10, 30, 40]}, {
    donut: !0,
    donutWidth: 60,
    startAngle: 270,
    total: 200,
