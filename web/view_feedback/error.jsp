...
<html lang="en">
    ...
    <body class="loading authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    <h3 class="mt-4">出错了 </h3>
                                    <p class="text-muted mb-0">出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了出错了</p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Return to <a href="../view_auth/staff_index.jsp" class="text-white ms-1"><b>Home</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
             <script>document.write(new Date().getFullYear())</script> &copy; Mapping Car by <a href="#" class="text-white-50">第四小组</a>
        </footer>
