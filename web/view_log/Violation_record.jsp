            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <s:if test="#request.myViolation==null">
                        <h4 class="text-center mb-5 text-primary">你似乎没有违规记录哦...</h4>
                    </s:if>
                    ...
                    <div class="card d-block">
                        <div class="card-body">
                            ...
                            <h4><button type="button" class="btn btn-outline-danger me-2"><s:property value="#VIO.type"/></button><s:property value="#VIO.id"/></h4>
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-4"><s:property value="#VIO.details"/></p>
                            </div>
