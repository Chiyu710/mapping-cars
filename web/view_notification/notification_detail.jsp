                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm-11">
                                            <div class="d-flex align-items-start">
                                                <div class="w-100">
                                                    <b class="mt-0 mb-2 me-2 font-16">车辆保养提醒</b> <text class="mb-0 me-2 text-muted">2021年11月19日11：30</text>
                                                        <div class="badge font-14 bg-soft-danger text-danger p-1">High</div>
                                                </div>
                                            </div>
                                            <br>
                                            <p class="mb-0">1234号机动车驾驶人您驾驶的机动车已经n年n月n天没有进行保养维修了，请尽快申请车辆保养维修
                                                ，以免车辆发生故障。出于安全考虑，若您于n年n月n日前还没有进行车辆维修，您的出车申请将被冻结
                                                <a href="../view_application/fix_application.jsp"> &nbsp;>>申请维修</a></p>
                                        </div>
