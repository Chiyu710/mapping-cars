                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card text-center">
                            <div class="card-body">
                                <h4 class="mb-0"><s:property value="#session.user.name"/></h4>
                                ...
                                <div class="text-start mt-3">
                                    ...
                                    <p class="text-muted mb-2 font-13"><strong>姓名 :</strong> <span class="ms-2"><s:property value="#session.user.name"/></span></p>

                                    <p class="text-muted mb-2 font-13"><strong>电话 :</strong><span class="ms-2"><s:property value="#session.user.age"/></span></p>

                                    <p class="text-muted mb-2 font-13"><strong>邮箱 :</strong> <span class="ms-2"><s:property value="#session.user.email"/></span></p>

                                    <p class="text-muted mb-1 font-13"><strong>所属部门 :</strong> <span class="ms-2"><s:property value="#session.user.department"/></span></p>
                                </div>
