                        ...
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <div class="text-start mt-3">
                                    ...
                                    <p class="text-muted mb-2 font-13"><strong>姓名 :</strong> <span class="ms-2"><s:property value="#session.admin.name"/></span></p>
                                    ...
                                    <p class="text-muted mb-1 font-13"><strong>所属部门 :</strong> <span class="ms-2"><s:property value="#session.admin.position"/></span></p>
                                </div>
